...
int main(int argc, char **argv)
{
    ...
    sparta::SimulationInfo::getInstance() = sparta::SimulationInfo("Atlas RISC-V Functional Model",
                                                                   argc,
                                                                   argv, 
                                                                   "v0.0.0",
                                                                   "", {});
    ...
    try{
        ...
        if(workload.empty()) {
            std::cerr << "ERROR: Missing a workload to run. Provide an ELF or JSON to run" << std::endl;
            std::cerr << USAGE;
            return -1;
        }
