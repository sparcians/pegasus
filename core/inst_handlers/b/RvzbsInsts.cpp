...
namespace pegasus
{
    ...
    void RvzbsInsts::getInstHandlers(std::map<std::string, Action> & inst_handlers)
    {
        ...
        inst_handlers.emplace(
            "bclri",
            pegasus::Action::createAction<&RvzbsInsts::immOpHandler_<XLEN, Bclr<XLEN>>, RvzbInstsBase>(
        ...
        inst_handlers.emplace(
            "bexti",
            pegasus::Action::createAction<&RvzbsInsts::immOpHandler_<XLEN, Bext<XLEN>>, RvzbInstsBase>(
        ...
        inst_handlers.emplace(
            "binvi",
            pegasus::Action::createAction<&RvzbsInsts::immOpHandler_<XLEN, Binv<XLEN>>, RvzbInstsBase>(
        ...
        inst_handlers.emplace(
            "bseti",
            pegasus::Action::createAction<&RvzbsInsts::immOpHandler_<XLEN, Bset<XLEN>>, RvzbInstsBase>(
