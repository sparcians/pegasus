    ...
    void RvzbsInsts::getInstHandlers(std::map<std::string, Action> & inst_handlers)
    {
        static_assert(std::is_same_v<XLEN, RV64> || std::is_same_v<XLEN, RV32>);
            ...
            inst_handlers.emplace(
                "bclr", atlas::Action::createAction<&RvzbsInsts::binaryOpHandler<XLEN, RvzbsInsts::bclr<XLEN>>, RvzbsInsts>(
                            nullptr, "bclr", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "bclri", atlas::Action::createAction<&RvzbsInsts::immOpHandler<XLEN, RvzbsInsts::bclr<XLEN>>, RvzbsInsts>(
                            nullptr, "bclri", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "bext", atlas::Action::createAction<&RvzbsInsts::binaryOpHandler<XLEN, RvzbsInsts::bext<XLEN>>, RvzbsInsts>(
                            nullptr, "bext", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "bexti", atlas::Action::createAction<&RvzbsInsts::immOpHandler<XLEN, RvzbsInsts::bext<XLEN>>, RvzbsInsts>(
                            nullptr, "bexti", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "binv", atlas::Action::createAction<&RvzbsInsts::binaryOpHandler<XLEN, RvzbsInsts::binv<XLEN>>, RvzbsInsts>(
                            nullptr, "binv", ActionTags::EXECUTE_TAG));   
            inst_handlers.emplace(
                "binvi", atlas::Action::createAction<&RvzbsInsts::immOpHandler<XLEN, RvzbsInsts::binv<XLEN>>, RvzbsInsts>(
                            nullptr, "binvi", ActionTags::EXECUTE_TAG)); 
            inst_handlers.emplace(
                "bset", atlas::Action::createAction<&RvzbsInsts::binaryOpHandler<XLEN, RvzbsInsts::bset<XLEN>>, RvzbsInsts>(
                            nullptr, "bset", ActionTags::EXECUTE_TAG)); 
            inst_handlers.emplace(
                "bseti", atlas::Action::createAction<&RvzbsInsts::immOpHandler<XLEN, RvzbsInsts::bset<XLEN>>, RvzbsInsts>(
