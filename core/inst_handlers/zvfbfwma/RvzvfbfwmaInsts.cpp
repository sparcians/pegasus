...
namespace pegasus
{
    ...
    void RvzvfbfwmaInsts::getInstHandlers(InstHandlers::InstHandlersMap & inst_handlers)
    {
        ...
        (void)inst_handlers;
        //inst_handlers.emplace("vfwmaccbf16_vv", pegasus::Action::createAction<&RvzvfbfwmaInsts::, RvzvfbfwmaInsts>("vfwmaccbf16_vv", ActionTags::EXECUTE_TAG));
        //inst_handlers.emplace("vfwmaccbf16_vf", pegasus::Action::createAction<&RvzvfbfwmaInsts::, RvzvfbfwmaInsts>("vfwmaccbf16_vf", ActionTags::EXECUTE_TAG));
    }
