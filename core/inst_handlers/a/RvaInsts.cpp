...
namespace atlas
{
    ...
    void RvaInsts::getInstComputeAddressHandlers(std::map<std::string, Action> & inst_handlers)
    {
        ...
        inst_handlers.emplace(
            "amoadd_w",
            atlas::Action::createAction<&RvaInsts::computeAddressHandler_<XLEN>, RvaInsts>(
        ...
        inst_handlers.emplace(
            "lr_w", atlas::Action::createAction<&RvaInsts::computeAddressHandler_<XLEN>, RvaInsts>(
                        nullptr, "lr_w", ActionTags::COMPUTE_ADDR_TAG));
        inst_handlers.emplace(
            "sc_w", atlas::Action::createAction<&RvaInsts::computeAddressHandler_<XLEN>, RvaInsts>(
        ...
        if constexpr (std::is_same_v<XLEN, RV64>)
        {
            inst_handlers.emplace(
                "amoadd_d",
                atlas::Action::createAction<&RvaInsts::computeAddressHandler_<RV64>, RvaInsts>(
    ...
    void RvaInsts::getInstHandlers(std::map<std::string, Action> & inst_handlers)
    {
        ...
        if constexpr (std::is_same_v<XLEN, RV64>)
        {
            inst_handlers.emplace(
                "amoadd_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, std::plus<D>>,
                                            RvaInsts>(nullptr, "amoadd_d",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoadd_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, W, std::plus<W>>,
                                            RvaInsts>(nullptr, "amoadd_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoand_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, std::bit_and<D>>,
                                            RvaInsts>(nullptr, "amoand_d",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoand_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, W, std::bit_and<W>>,
            ...
            inst_handlers.emplace(
                "amomaxu_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, MaxFunctor<D>>,
                                            RvaInsts>(nullptr, "amomaxu_d",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amomaxu_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, W, MaxFunctor<W>>,
            ...
            inst_handlers.emplace(
                "amominu_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, MinFunctor<D>>,
                                            RvaInsts>(nullptr, "amominu_d",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amominu_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, W, MinFunctor<W>>,
                                            RvaInsts>(nullptr, "amominu_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoor_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, std::bit_or<D>>,
                                            RvaInsts>(nullptr, "amoor_d", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoor_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, W, std::bit_or<W>>,
                                            RvaInsts>(nullptr, "amoor_w", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoswap_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, SwapFunctor<D>>,
                                            RvaInsts>(nullptr, "amoswap_d",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoswap_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, W, SwapFunctor<W>>,
                                            RvaInsts>(nullptr, "amoswap_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoxor_d",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV64, D, std::bit_xor<D>>,
        ...
        else if constexpr (std::is_same_v<XLEN, RV32>)
        {
            inst_handlers.emplace(
                "amoadd_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV32, W, std::plus<W>>,
                                            RvaInsts>(nullptr, "amoadd_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoand_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV32, W, std::bit_and<W>>,
                                            RvaInsts>(nullptr, "amoand_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amomax_w",
            ...
            inst_handlers.emplace(
                "amomaxu_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV32, W, MaxFunctor<W>>,
                                            RvaInsts>(nullptr, "amomaxu_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amomin_w",
            ...
            inst_handlers.emplace(
                "amominu_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV32, W, MinFunctor<W>>,
                                            RvaInsts>(nullptr, "amominu_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoor_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV32, W, std::bit_or<W>>,
                                            RvaInsts>(nullptr, "amoor_w", ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoswap_w",
                atlas::Action::createAction<&RvaInsts::amoHandler_<RV32, W, SwapFunctor<W>>,
                                            RvaInsts>(nullptr, "amoswap_w",
                                                      ActionTags::EXECUTE_TAG));
            inst_handlers.emplace(
                "amoxor_w",
    ...
    template <typename T>
    Action::ItrType RvaInsts::computeAddressHandler_(AtlasState* state, Action::ItrType action_it)
    {
