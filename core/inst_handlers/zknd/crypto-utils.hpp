...
namespace pegasus
{
    ...
    // AES Forward S-box lookup table - whisper table
    static constexpr uint8_t AES_SBOX_FWD[256] = {
    ...
    static constexpr uint32_t AES_RCON[10] = {0x01000000, 0x02000000, 0x04000000, 0x08000000,
    ...
    static uint32_t aes_mixcolumn_inv(uint32_t col)
    {
        ...
        const uint8_t s2 = (col >> 16) & 0xFF;
        const uint8_t s3 = (col >> 24) & 0xFF;
