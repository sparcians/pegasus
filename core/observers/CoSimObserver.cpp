...
namespace atlas
{
    ...
    Action* CoSimObserver::preExecute_(AtlasState* state, Action*)
    {
    ...
    Action* CoSimObserver::preException_(AtlasState* state, Action* action)
    {
    ...
    Action* CoSimObserver::postExecute_(AtlasState* state, Action*)
    {
