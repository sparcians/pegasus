...
namespace atlas
{
    ...
    class PageTableEntry
    {
      ...
      public:
        ...
        uint32_t getPPN1() const { return (Mode == MMUMode::SV32) ? ((PPN_ >> 10) & 0xFFF) : 0; }  // 12 bits for PPN1
        uint32_t getPPN0() const { return (Mode == MMUMode::SV32) ? (PPN_ & 0x3FF) : 0; }  // 10 bits for PPN0
