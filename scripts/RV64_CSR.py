...
CSR64_DEFS = {
    ...
    0x010: ["dmcontrol", "Debug module control", {
        "Resv"            : { "high_bit" : 63, "low_bit" : 32, "readonly" : True,  "desc" : "undocumented" },
    ...
    0x011: ["dmstatus", "Debug module status", {
        "Resv"            : { "high_bit" : 63, "low_bit" : 23, "readonly" : True,  "desc" : "undocumented" },
    ...
    0x042: ["ucause", "Scratch register for user trap handlers.", {}],
    ...
    0x001: ["fflags", "Floating-Point Accrued Exceptions.", {
        "Resv"   : { "high_bit" : 63, "low_bit" : 5, "readonly" : True,  "desc" : "undocumented" },
    ...
    0x003: ["fcsr", "Floating-Point Control and Status Register (frm + fflags).", {
        "Resv"   : { "high_bit" : 63, "low_bit" : 8, "readonly" : True,  "desc" : "undocumented" },
    ...
    # User Vector CSRs
    0x008: ["vstart", "The index of the first element to be executed by a vector instruction.", {}],
    0x009: ["vxsat", "To indicate whether a fixed-point instruction needs to saturate.", {
        ...
        "Resv"   : { "high_bit" : 63, "low_bit" : 1, "readonly" : True,  "desc" : "undocumented" },
    }],
    0x00A: ["vxrm", "Vector fixed-point rounding-mode register.", {
        "vxrm"   : { "high_bit" : 1,  "low_bit" : 0, "readonly" : False, "desc" : "Rounding mode" },
        "Resv"   : { "high_bit" : 63, "low_bit" : 2, "readonly" : True,  "desc" : "undocumented" },
    }],
    0x00F: ["vcsr", "Vector control and status register.", {
        ...
        "Resv"   : { "high_bit" : 63, "low_bit" : 3, "readonly" : True,  "desc" : "undocumented" },
    }],
    0xC20: ["vl", "Vector length register.", {}],
    0xC21: ["vtype", "Vector type register.", {
        ...
        "Resv"   : { "high_bit" : 62, "low_bit" : 8, "readonly" : True,  "desc" : "undocumented" },
        "vill"   : { "high_bit" : 63, "low_bit" : 63,"readonly" : False, "desc" : "Illegal value if set" }
    }],
    0xC22: ["vlenb", "Vector byte length.", {}],
    ...
    0xC05: ["hpmcounter5", "Performance-monitoring counter.", {}],
    0xC06: ["hpmcounter6", "Performance-monitoring counter.", {}],
    0xC07: ["hpmcounter7", "Performance-monitoring counter.", {}],
    0xC08: ["hpmcounter8", "Performance-monitoring counter.", {}],
    0xC09: ["hpmcounter9", "Performance-monitoring counter.", {}],
    0xC0A: ["hpmcounter10", "Performance-monitoring counter.", {}],
    0xC0B: ["hpmcounter11", "Performance-monitoring counter.", {}],
    0xC0C: ["hpmcounter12", "Performance-monitoring counter.", {}],
    0xC0D: ["hpmcounter13", "Performance-monitoring counter.", {}],
    0xC0E: ["hpmcounter14", "Performance-monitoring counter.", {}],
    0xC0F: ["hpmcounter15", "Performance-monitoring counter.", {}],
    0xC10: ["hpmcounter16", "Performance-monitoring counter.", {}],
    0xC11: ["hpmcounter17", "Performance-monitoring counter.", {}],
    0xC12: ["hpmcounter18", "Performance-monitoring counter.", {}],
    0xC13: ["hpmcounter19", "Performance-monitoring counter.", {}],
    0xC14: ["hpmcounter20", "Performance-monitoring counter.", {}],
    0xC15: ["hpmcounter21", "Performance-monitoring counter.", {}],
    0xC16: ["hpmcounter22", "Performance-monitoring counter.", {}],
    0xC17: ["hpmcounter23", "Performance-monitoring counter.", {}],
    0xC18: ["hpmcounter24", "Performance-monitoring counter.", {}],
    0xC19: ["hpmcounter25", "Performance-monitoring counter.", {}],
    0xC1A: ["hpmcounter26", "Performance-monitoring counter.", {}],
    0xC1B: ["hpmcounter27", "Performance-monitoring counter.", {}],
    0xC1C: ["hpmcounter28", "Performance-monitoring counter.", {}],
    0xC1D: ["hpmcounter29", "Performance-monitoring counter.", {}],
    0xC1E: ["hpmcounter30", "Performance-monitoring counter.", {}],
    ...
    0x100: ["sstatus", "Supervisor status register.", {
        ...
        "WPRI" : { "high_bit" : 62, "low_bit" : 34, "readonly" : True,  "desc" : "resv" },
        "UXL"  : { "high_bit" : 33, "low_bit" : 32, "readonly" : True,  "desc" : "Controls XLEN value for U-mode" },
        "WPRI" : { "high_bit" : 31, "low_bit" : 20, "readonly" : True,  "desc" : "resv" },
    ...
    0x104: ["sie", "Supervisor interrupt-enable register.", {
        "WPRI"  : { "high_bit" : 63, "low_bit" : 10, "readonly" : True,  "desc" : "reserved" },
        ...
        "WPRI"  : { "high_bit" : 7,  "low_bit"  : 6, "readonly" : True,  "desc" : "undocumented" },
    ...
    0x300: ["mstatus",    "Machine status register.", {
        "SD"   : { "high_bit" : 63, "low_bit" : 63, "readonly" : False, "desc" : "Fast-check bit: summarizes either FS/XS/VS set" },
        "WPRI" : { "high_bit" : 62, "low_bit" : 40, "readonly" : True,  "desc" : "reserved" },
        ...
        "SXL"  : { "high_bit" : 35, "low_bit" : 34, "readonly" : True,  "desc" : "Controls XLEN value for S-mode" },
        "UXL"  : { "high_bit" : 33, "low_bit" : 32, "readonly" : True,  "desc" : "Controls XLEN value for U-mode" },
        "WPRI" : { "high_bit" : 31, "low_bit" : 23, "readonly" : True,  "desc" : "undocumented" },
    ...
    0x301: ["misa",       "ISA and extension.", {
        "MXL"  : { 'high_bit' : 63, 'low_bit' : 62, 'readonly' : False, "desc" : "Machine XLEN" },
        "WLRL" : { 'high_bit' : 61, 'low_bit' : 26, 'readonly' : False, "desc" : "Unknown" },
    ...
    0x302: ["medeleg", "Machine exception delegation register.", {
        "VirtualInst"        : {"high_bit" : 22, "low_bit" : 22, "readonly" : False, "desc" : "Delegate virtual inst exceptions" },
        "GuestLoadPageFault" : {"high_bit" : 21, "low_bit" : 21, "readonly" : False, "desc" : "Delegate guest load page fault exceptions" },
        "GuestInstPageFault" : {"high_bit" : 20, "low_bit" : 20, "readonly" : False, "desc" : "Delegate guest inst page fault exceptions" },
        "HardwareErrorFault" : {"high_bit" : 19, "low_bit" : 19, "readonly" : False, "desc" : "Delegate hardware error fault exceptions" },
        "SoftwareCheckFault" : {"high_bit" : 18, "low_bit" : 18, "readonly" : False, "desc" : "Delegate software check fault exceptions" },
        "StorePageFault"     : {"high_bit" : 15, "low_bit" : 15, "readonly" : False, "desc" : "Delegate store page fault exceptions" },
        "LoadPageFault"      : {"high_bit" : 13, "low_bit" : 13, "readonly" : False, "desc" : "Delegate load page fault exceptions" },
        "InstPageFault"      : {"high_bit" : 12, "low_bit" : 12, "readonly" : False, "desc" : "Delegate inst page fault exceptions" },
        "ECallVS"            : {"high_bit" : 10, "low_bit" : 10, "readonly" : False, "desc" : "Delegate ecall VS fault exceptions" },
        "ECallS"             : {"high_bit" :  9, "low_bit" :  9, "readonly" : False, "desc" : "Delegate ecall S fault exceptions" },
        "ECallU"             : {"high_bit" :  8, "low_bit" :  8, "readonly" : False, "desc" : "Delegate ecall U fault exceptions" },
        "StoreAccess"        : {"high_bit" :  7, "low_bit" :  7, "readonly" : False, "desc" : "Delegate store access fault exceptions" },
        "MisalignedStore"    : {"high_bit" :  6, "low_bit" :  6, "readonly" : False, "desc" : "Delegate misaligned store fault exceptions" },
        "LoadAccess"         : {"high_bit" :  5, "low_bit" :  5, "readonly" : False, "desc" : "Delegate load access fault exceptions" },
        "MisalignedLoad"     : {"high_bit" :  4, "low_bit" :  4, "readonly" : False, "desc" : "Delegate misaligned load fault exceptions" },
        "Breakpoint"         : {"high_bit" :  3, "low_bit" :  3, "readonly" : False, "desc" : "Delegate breakpoint fault exceptions" },
        "IllegalInst"        : {"high_bit" :  2, "low_bit" :  2, "readonly" : False, "desc" : "Delegate illegal inst fault exceptions" },
        "InstAccessFault"    : {"high_bit" :  1, "low_bit" :  1, "readonly" : False, "desc" : "Delegate inst access fault exceptions" },
        "InstAddrMisaligned" : {"high_bit" :  0, "low_bit" :  0, "readonly" : False, "desc" : "Delegate inst addr misaligned fault exceptions" }
    }],
    ...
    0x344: ["mip", "Machine interrupt pending.", {
        "WPRI"  : { "high_bit" : 63, "low_bit" : 13, "readonly" : True,  "desc" : "undocumented" },
    ...
    0x747: ["mseccfg",  "Machine security configuration register.", {
        "WPRI" : { "high_bit" :  63, "low_bit" :  0, "readonly" : False, "desc" : "reserved" },
    }],

    # Machine Memory Protection
    0x3a0: ["pmpcfg0",  "Physical memory protection configuration.", {}],
    0x3a2: ["pmpcfg2",  "Physical memory protection configuration.", {}],
    0x3a4: ["pmpcfg4",  "Physical memory protection configuration.", {}],
    0x3a6: ["pmpcfg6",  "Physical memory protection configuration.", {}],
    0x3a8: ["pmpcfg8",  "Physical memory protection configuration.", {}],
    0x3aa: ["pmpcfg10", "Physical memory protection configuration.", {}],
    0x3ac: ["pmpcfg12", "Physical memory protection configuration.", {}],
    ...
    0x3b2: ["pmpaddr2",  "Physical memory protection address register.", {}],
    0x3b3: ["pmpaddr3",  "Physical memory protection address register.", {}],
    0x3b4: ["pmpaddr4",  "Physical memory protection address register.", {}],
    0x3b5: ["pmpaddr5",  "Physical memory protection address register.", {}],
    0x3b6: ["pmpaddr6",  "Physical memory protection address register.", {}],
    0x3b7: ["pmpaddr7",  "Physical memory protection address register.", {}],
    0x3b8: ["pmpaddr8",  "Physical memory protection address register.", {}],
    0x3b9: ["pmpaddr9",  "Physical memory protection address register.", {}],
    0x3ba: ["pmpaddr10", "Physical memory protection address register.", {}],
    0x3bb: ["pmpaddr11", "Physical memory protection address register.", {}],
    0x3bc: ["pmpaddr12", "Physical memory protection address register.", {}],
    0x3bd: ["pmpaddr13", "Physical memory protection address register.", {}],
    0x3be: ["pmpaddr14", "Physical memory protection address register.", {}],
    0x3bf: ["pmpaddr15", "Physical memory protection address register.", {}],
    0x3c0: ["pmpaddr16", "Physical memory protection address register.", {}],
    0x3c1: ["pmpaddr17", "Physical memory protection address register.", {}],
    0x3c2: ["pmpaddr18", "Physical memory protection address register.", {}],
    0x3c3: ["pmpaddr19", "Physical memory protection address register.", {}],
    0x3c4: ["pmpaddr20", "Physical memory protection address register.", {}],
    0x3c5: ["pmpaddr21", "Physical memory protection address register.", {}],
    0x3c6: ["pmpaddr22", "Physical memory protection address register.", {}],
    0x3c7: ["pmpaddr23", "Physical memory protection address register.", {}],
    0x3c8: ["pmpaddr24", "Physical memory protection address register.", {}],
    0x3c9: ["pmpaddr25", "Physical memory protection address register.", {}],
    0x3ca: ["pmpaddr26", "Physical memory protection address register.", {}],
    0x3cb: ["pmpaddr27", "Physical memory protection address register.", {}],
    0x3cc: ["pmpaddr28", "Physical memory protection address register.", {}],
    0x3cd: ["pmpaddr29", "Physical memory protection address register.", {}],
    0x3ce: ["pmpaddr30", "Physical memory protection address register.", {}],
    0x3cf: ["pmpaddr31", "Physical memory protection address register.", {}],
    0x3d0: ["pmpaddr32", "Physical memory protection address register.", {}],
    0x3d1: ["pmpaddr33", "Physical memory protection address register.", {}],
    0x3d2: ["pmpaddr34", "Physical memory protection address register.", {}],
    0x3d3: ["pmpaddr35", "Physical memory protection address register.", {}],
    0x3d4: ["pmpaddr36", "Physical memory protection address register.", {}],
    0x3d5: ["pmpaddr37", "Physical memory protection address register.", {}],
    0x3d6: ["pmpaddr38", "Physical memory protection address register.", {}],
    0x3d7: ["pmpaddr39", "Physical memory protection address register.", {}],
    0x3d8: ["pmpaddr40", "Physical memory protection address register.", {}],
    0x3d9: ["pmpaddr41", "Physical memory protection address register.", {}],
    0x3da: ["pmpaddr42", "Physical memory protection address register.", {}],
    0x3db: ["pmpaddr43", "Physical memory protection address register.", {}],
    0x3dc: ["pmpaddr44", "Physical memory protection address register.", {}],
    0x3dd: ["pmpaddr45", "Physical memory protection address register.", {}],
    0x3de: ["pmpaddr46", "Physical memory protection address register.", {}],
    0x3df: ["pmpaddr47", "Physical memory protection address register.", {}],
    0x3e0: ["pmpaddr48", "Physical memory protection address register.", {}],
    0x3e1: ["pmpaddr49", "Physical memory protection address register.", {}],
    0x3e2: ["pmpaddr50", "Physical memory protection address register.", {}],
    0x3e3: ["pmpaddr51", "Physical memory protection address register.", {}],
    0x3e4: ["pmpaddr52", "Physical memory protection address register.", {}],
    0x3e5: ["pmpaddr53", "Physical memory protection address register.", {}],
    0x3e6: ["pmpaddr54", "Physical memory protection address register.", {}],
    0x3e7: ["pmpaddr55", "Physical memory protection address register.", {}],
    0x3e8: ["pmpaddr56", "Physical memory protection address register.", {}],
    0x3e9: ["pmpaddr57", "Physical memory protection address register.", {}],
    0x3ea: ["pmpaddr58", "Physical memory protection address register.", {}],
    0x3eb: ["pmpaddr59", "Physical memory protection address register.", {}],
    0x3ec: ["pmpaddr60", "Physical memory protection address register.", {}],
    0x3ed: ["pmpaddr61", "Physical memory protection address register.", {}],
    ...
    0xB05: ["mhpmcounter5", "Machine performance-monitoring counter.", {}],
    0xB06: ["mhpmcounter6", "Machine performance-monitoring counter.", {}],
    0xB07: ["mhpmcounter7", "Machine performance-monitoring counter.", {}],
    0xB08: ["mhpmcounter8", "Machine performance-monitoring counter.", {}],
    0xB09: ["mhpmcounter9", "Machine performance-monitoring counter.", {}],
    0xB0A: ["mhpmcounter10", "Machine performance-monitoring counter.", {}],
    0xB0B: ["mhpmcounter11", "Machine performance-monitoring counter.", {}],
    0xB0C: ["mhpmcounter12", "Machine performance-monitoring counter.", {}],
    0xB0D: ["mhpmcounter13", "Machine performance-monitoring counter.", {}],
    0xB0E: ["mhpmcounter14", "Machine performance-monitoring counter.", {}],
    0xB0F: ["mhpmcounter15", "Machine performance-monitoring counter.", {}],
    0xB10: ["mhpmcounter16", "Machine performance-monitoring counter.", {}],
    0xB11: ["mhpmcounter17", "Machine performance-monitoring counter.", {}],
    0xB12: ["mhpmcounter18", "Machine performance-monitoring counter.", {}],
    0xB13: ["mhpmcounter19", "Machine performance-monitoring counter.", {}],
    0xB14: ["mhpmcounter20", "Machine performance-monitoring counter.", {}],
    0xB15: ["mhpmcounter21", "Machine performance-monitoring counter.", {}],
    0xB16: ["mhpmcounter22", "Machine performance-monitoring counter.", {}],
    0xB17: ["mhpmcounter23", "Machine performance-monitoring counter.", {}],
    0xB18: ["mhpmcounter24", "Machine performance-monitoring counter.", {}],
    0xB19: ["mhpmcounter25", "Machine performance-monitoring counter.", {}],
    0xB1A: ["mhpmcounter26", "Machine performance-monitoring counter.", {}],
    0xB1B: ["mhpmcounter27", "Machine performance-monitoring counter.", {}],
    0xB1C: ["mhpmcounter28", "Machine performance-monitoring counter.", {}],
    0xB1D: ["mhpmcounter29", "Machine performance-monitoring counter.", {}],
    0xB1E: ["mhpmcounter30", "Machine performance-monitoring counter.", {}],
    ...
    0x325: ["mhpmevent5", "Machine performance-monitoring event selector.", {}],
    0x326: ["mhpmevent6", "Machine performance-monitoring event selector.", {}],
    0x327: ["mhpmevent7", "Machine performance-monitoring event selector.", {}],
    0x328: ["mhpmevent8", "Machine performance-monitoring event selector.", {}],
    0x329: ["mhpmevent9", "Machine performance-monitoring event selector.", {}],
    0x32A: ["mhpmevent10", "Machine performance-monitoring event selector.", {}],
    0x32B: ["mhpmevent11", "Machine performance-monitoring event selector.", {}],
    0x32C: ["mhpmevent12", "Machine performance-monitoring event selector.", {}],
    0x32D: ["mhpmevent13", "Machine performance-monitoring event selector.", {}],
    0x32E: ["mhpmevent14", "Machine performance-monitoring event selector.", {}],
    0x32F: ["mhpmevent15", "Machine performance-monitoring event selector.", {}],
    0x330: ["mhpmevent16", "Machine performance-monitoring event selector.", {}],
    0x331: ["mhpmevent17", "Machine performance-monitoring event selector.", {}],
    0x332: ["mhpmevent18", "Machine performance-monitoring event selector.", {}],
    0x333: ["mhpmevent19", "Machine performance-monitoring event selector.", {}],
    0x334: ["mhpmevent20", "Machine performance-monitoring event selector.", {}],
    0x335: ["mhpmevent21", "Machine performance-monitoring event selector.", {}],
    0x336: ["mhpmevent22", "Machine performance-monitoring event selector.", {}],
    0x337: ["mhpmevent23", "Machine performance-monitoring event selector.", {}],
    0x338: ["mhpmevent24", "Machine performance-monitoring event selector.", {}],
    0x339: ["mhpmevent25", "Machine performance-monitoring event selector.", {}],
    0x33A: ["mhpmevent26", "Machine performance-monitoring event selector.", {}],
    0x33B: ["mhpmevent27", "Machine performance-monitoring event selector.", {}],
    0x33C: ["mhpmevent28", "Machine performance-monitoring event selector.", {}],
    0x33D: ["mhpmevent29", "Machine performance-monitoring event selector.", {}],
    0x33E: ["mhpmevent30", "Machine performance-monitoring event selector.", {}],
    ...
    0x243: ["vstval",     "Virtual supervisor trap value register", {}],
    ...
    0x600: ["hstatus",    "Hypervisor status register", {
        "WPRI"  : { "high_bit" : 63, "low_bit" : 34, "readonly" : True,  "desc" : "reserved" },
    ...
    0x7a1: ["tdata1",   "First Debug/Trace trigger data register.", {
        "type"  : { "high_bit" : 63, "low_bit" : 60, "readonly" : False, "desc" : "Type of trigger" },
        "dmode" : { "high_bit" : 59, "low_bit" : 59, "readonly" : False, "desc" : "If bit is set, only Debug Mode can write to the tdata registers. Other writes are ignored." },
        "data"  : { "high_bit" : 58, "low_bit" : 0,  "readonly" : False, "desc" : "Trigger-specific data" },
        "mcontrol_maskmax" : { "high_bit" : 58, "low_bit" : 53, "readonly" : False, "desc" : "TODO" },
        ...
        "etrigger_hit"    : { "high_bit" : 58, "low_bit" : 58, "readonly" : False, "desc" : "Set when this trigger matches (optional)" },
        ...
        "itrigger_hit"    : { "high_bit" : 58, "low_bit" : 58, "readonly" : False, "desc" : "Set when this trigger matches (optional)" },
    ...
    0x7a5: ["tcontrol", "Trigger control", {
        "Resv"  : { "high_bit" : 63, "low_bit" : 8,  "readonly" : True,  "desc" : "Tied to zero" },
    ...
    0x7a8: ["mcontext", "Machine context", {}],
    0x7aa: ["scontext", "Supervisor context", {}],
