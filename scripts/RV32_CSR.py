...
CSR32_DEFS = {
    ...
    0xC20: ["vl", "Vector legnth register.", {}],
    ...
    # RV32 only
    0xC80: ["cycleh", "Upper 32 bits of cycle, RV32 only.", {}],
    0xC81: ["timeh", "Upper 32 bits of time, RV32 only.", {}],
    0xC82: ["instreth", "Upper 32 bits of instret, RV32 only.", {}],
    0xC83: ["hpmcounter3h", "Upper 32 bits of hpmcounter3, RV32 only.", {}],
    0xC84: ["hpmcounter4h", "Upper 32 bits of hpmcounter4, RV32 only.", {}],
    0xC85: ["hpmcounter5h", "Upper 32 bits of hpmcounter5, RV32 only.", {}],
    0xC86: ["hpmcounter6h", "Upper 32 bits of hpmcounter6, RV32 only.", {}],
    0xC87: ["hpmcounter7h", "Upper 32 bits of hpmcounter7, RV32 only.", {}],
    0xC88: ["hpmcounter8h", "Upper 32 bits of hpmcounter8, RV32 only.", {}],
    0xC89: ["hpmcounter9h", "Upper 32 bits of hpmcounter9, RV32 only.", {}],
    0xC8A: ["hpmcounter10h", "Upper 32 bits of hpmcounter10, RV32 only.", {}],
    0xC8B: ["hpmcounter11h", "Upper 32 bits of hpmcounter11, RV32 only.", {}],
    0xC8C: ["hpmcounter12h", "Upper 32 bits of hpmcounter12, RV32 only.", {}],
    0xC8D: ["hpmcounter13h", "Upper 32 bits of hpmcounter13, RV32 only.", {}],
    0xC8E: ["hpmcounter14h", "Upper 32 bits of hpmcounter14, RV32 only.", {}],
    0xC8F: ["hpmcounter15h", "Upper 32 bits of hpmcounter15, RV32 only.", {}],
    0xC90: ["hpmcounter16h", "Upper 32 bits of hpmcounter16, RV32 only.", {}],
    0xC91: ["hpmcounter17h", "Upper 32 bits of hpmcounter17, RV32 only.", {}],
    0xC92: ["hpmcounter18h", "Upper 32 bits of hpmcounter18, RV32 only.", {}],
    0xC93: ["hpmcounter19h", "Upper 32 bits of hpmcounter19, RV32 only.", {}],
    0xC94: ["hpmcounter20h", "Upper 32 bits of hpmcounter20, RV32 only.", {}],
    0xC95: ["hpmcounter21h", "Upper 32 bits of hpmcounter21, RV32 only.", {}],
    0xC96: ["hpmcounter22h", "Upper 32 bits of hpmcounter22, RV32 only.", {}],
    0xC97: ["hpmcounter23h", "Upper 32 bits of hpmcounter23, RV32 only.", {}],
    0xC98: ["hpmcounter24h", "Upper 32 bits of hpmcounter24, RV32 only.", {}],
    0xC99: ["hpmcounter25h", "Upper 32 bits of hpmcounter25, RV32 only.", {}],
    0xC9A: ["hpmcounter26h", "Upper 32 bits of hpmcounter26, RV32 only.", {}],
    0xC9B: ["hpmcounter27h", "Upper 32 bits of hpmcounter27, RV32 only.", {}],
    0xC9C: ["hpmcounter28h", "Upper 32 bits of hpmcounter28, RV32 only.", {}],
    0xC9D: ["hpmcounter29h", "Upper 32 bits of hpmcounter29, RV32 only.", {}],
    0xC9E: ["hpmcounter30h", "Upper 32 bits of hpmcounter30, RV32 only.", {}],
    ...
    0x3a1: ["pmpcfg1",  "Physical memory protection configuration.", {}],
    0x3a2: ["pmpcfg2",  "Physical memory protection configuration.", {}],
    0x3a3: ["pmpcfg3",  "Physical memory protection configuration.", {}],
    0x3a4: ["pmpcfg4",  "Physical memory protection configuration.", {}],
    0x3a5: ["pmpcfg5",  "Physical memory protection configuration.", {}],
    0x3a6: ["pmpcfg6",  "Physical memory protection configuration.", {}],
    0x3a7: ["pmpcfg7",  "Physical memory protection configuration.", {}],
    0x3a8: ["pmpcfg8",  "Physical memory protection configuration.", {}],
    0x3a9: ["pmpcfg9",  "Physical memory protection configuration.", {}],
    0x3aa: ["pmpcfg10", "Physical memory protection configuration.", {}],
    0x3ab: ["pmpcfg11", "Physical memory protection configuration.", {}],
    0x3ac: ["pmpcfg12", "Physical memory protection configuration.", {}],
    0x3ad: ["pmpcfg13", "Physical memory protection configuration.", {}],
    0x3ae: ["pmpcfg14", "Physical memory protection configuration.", {}],
    0x3af: ["pmpcfg15", "Physical memory protection configuration.", {}],
    ...
    0x31c: ["mstateen0h", "Machine State Enable Register 0, RV32 only", {
        ...
        "WPRI"    : { "high_bit" : 29, "low_bit" : 29, "readonly" : True , "desc" : "Reserved"                          },
    ...
    0x31d: ["mstateen1h", "Machine State Enable Register 1, RV32 only", {}],
    0x31e: ["mstateen2h", "Machine State Enable Register 2, RV32 only", {}],
    0x31f: ["mstateen3h", "Machine State Enable Register 3, RV32 only", {}],
    ...
    0x61c: ["hstateen0h", "Hypervisor State Enable Register 0, RV32 only", {
        ...
        "WPRI"    : { "high_bit" : 24, "low_bit" : 23, "readonly" : True , "desc" : "Reserved"                  },
        "CTR"     : { "high_bit" : 22, "low_bit" : 22, "readonly" : False, "desc" : "CTR register access"       },
        "CLIC"    : { "high_bit" : 21, "low_bit" : 21, "readonly" : False, "desc" : "CLIC registers access"     },
        "WPRI"    : { "high_bit" : 20, "low_bit" :  0, "readonly" : True , "desc" : "Reserved"                  },
    }],
    0x61d: ["hstateen1h", "Hypervisor State Enable Register 1, RV32 only", {}],
    0x61e: ["hstateen2h", "Hypervisor State Enable Register 2, RV32 only", {}],
    0x61f: ["hstateen3h", "Hypervisor State Enable Register 3, RV32 only", {}],
    ...
    0x61a: ["henvcfgh",    "Additional hypervisor environment configuration register, RV32 only", {}],
    0x605: ["htimedelta",  "Hypervisor time delta register", {}],
    0x615: ["htimedeltah", "Upper 32 bits of htimedelta, HSXLEN=32 only", {}],
