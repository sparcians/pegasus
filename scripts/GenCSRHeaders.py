...
def gen_csr_field_idxs_header(arch_name, reg_size):
    ...
    if data_width == 32:
        json_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "arch", arch_name, "rv32", "gen"))
    elif data_width == 64:
        json_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "arch", arch_name, "rv64", "gen"))
