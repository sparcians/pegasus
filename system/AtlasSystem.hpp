...
namespace atlas
{
    ...
    public:
        ...
        {
        public:
            AtlasSystemParameters(sparta::TreeNode * node) :
        ...
        constexpr static sparta::memory::addr_t ATLAS_SYSTEM_TOTAL_MEMORY = 0x8000000000000000; // 4G
    ...
    private:
        ...
        std::vector<std::unique_ptr<sparta::memory::BlockingMemoryObjectIFNode>> memory_object_nodes_;
