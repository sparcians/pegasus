...
public:
    ...
    sparta::RegisterBase::Definition* getAllDefns() {
        return register_defns_.data();
    }

    size_t getNumDefns() const {
        return register_defns_.size() - 1;
    }
...
private:
    ...
    public:
        ...
        const sparta::RegisterBase::Field::Definition& getDefn() const
        {
            return field_defn_;
        }
    ...
    std::map<sparta::RegisterBase::group_num_type, sparta::RegisterBase::group_idx_type> group_idx_map_;
};
